...
function randomPirate() {
    ...
    if (random < 10) {return pirateShip01};
    if (random < 25) {return pirateShip02};
    if (random < 45) {return pirateShip03};
    if (random < 80) {return pirateShip04};
    if (random <= 100) {return pirateShip05};
};
